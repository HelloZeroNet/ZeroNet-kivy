...
requirements = sqlite3,typing,openssl,m2crypto,gevent,msgpack-python,pil,hostpython3,git+https://github.com/kivy/plyer,android,kivy,sentry_sdk,urllib3,certifi
p4a.branch = master
...
p4a.source_dir = /home/data/vendor/python-for-android
